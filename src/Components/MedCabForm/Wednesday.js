...
export default function Wednesday(props){
    ...
    const addTime = () => {
        ...
        let currentWednesdayTimes = props.getState('wednesdayTimes');

        if (!currentWednesdayTimes) { // If WednesdayTimes not yet initialized, just add hrToAdd
            props.setState('wednesdayTimes', [hrToAdd]);
        }
       
        /* If wednesdayTimes already exists and it doesn't already have that time, then add */
        if ((currentWednesdayTimes) && (!currentWednesdayTimes.includes(hrToAdd))) {
            let newWednesdayTimes = [...currentWednesdayTimes, hrToAdd].sort((a, b) => a - b);
            props.setState('wednesdayTimes', newWednesdayTimes);
        }
    ...
    function timesList() {
        if (!props.getState('wednesdayTimes'))
            return null;
        /*
        return (
            <>
                <p>Your schedule will be:
                    ...
                    {props.getState('wednesdayTimes').map((time, index) => 
            ...
            <Row className="mt-3">
                        ...
                        <Card.Footer>
                            ...
                            <Row>
                                <Col>
                                    ...
                                    <Button variant={"danger"} block onClick={() => props.setState('wednesdayTimes', [])}>Clear stored values</Button>
                                </Col>
                            </Row>
                ...
                <Col md={8}>
                    <ListGroup className={"text-left"}>
                        ...
                        <ListGroup.Item>
                            When you are finished entering all your times, click "Proceed" at the bottom to proceed to Thursday. Or you may use the weekday buttons to jump directly to specific days.
                        </ListGroup.Item>
    ...
    function validate() {
        const currWednesdayTimes = props.getState('wednesdayTimes');
        /*if (!currWednesdayTimes || currWednesdayTimes.length === 0) {
        }*/
        (currWednesdayTimes && currWednesdayTimes.length > 0) ?
            (function () {
                props.jump(8);
            })()
            :
    ...
    function WednesdayErrorModal(props) {
        return (
            <Modal
                {...props}
                animation={false}
            ...
            >
                ...
                <Modal.Footer>
                    ...
                    <Button onClick={() => props.myjump(8)}>Continue Anyway</Button>

                </Modal.Footer>
            </Modal>
        );
    } // end Wednesday2ErrorModal

} // end function Wednesday
